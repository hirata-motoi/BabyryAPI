package Test::BabyryAPI::Loader::DB;
use strict;
use warnings;
...
sub load {
    ...
    my $mysqld = Test::BabyryAPI::mysqld->new;
    $self->mysqld($mysqld);
    ...
    $self->rewrite_resolver($BabyryAPI::DBI::resolver);
    $self;
}
...
sub _load_sql {
    ...
    my $module = Test::BabyryAPI->module_name(@module_name);
...
sub _loaded_resolver {
    ...
    my $resolver = $LOADED_RESOLVER || Test::BabyryAPI::DBHResolver->new;
    return $resolver;
}
